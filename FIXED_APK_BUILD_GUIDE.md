...
- APK was crashing because it tried to connect to development URLs (`https://syrianwomen-shop.preview.emergentagent.com`) that are not accessible on external Android devices
