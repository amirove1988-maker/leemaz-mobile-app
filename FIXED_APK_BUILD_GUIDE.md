...
- APK was crashing because it tried to connect to development URLs (`https://ecom-bilingual.preview.emergentagent.com`) that are not accessible on external Android devices
