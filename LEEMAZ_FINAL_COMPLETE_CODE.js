...
// ===============================
// COMPLETE LEEMAZ MOBILE APP - FINAL VERSION
// ===============================
  ...
  const HomeScreen = () => {
    ...
    const renderProduct = ({ item }) => (
      <TouchableOpacity
        ...
        onPress={() => {
          Alert.alert('Product Details', `You selected: ${item.name}\nPrice: $${item.price}\nRating: ${item.rating}/5`);
        }}
      >
        ...
        <View style={styles.productInfo}>
          ...
          {user?.user_type === 'buyer' && (
            <TouchableOpacity 
              ...
              onPress={() => Alert.alert('Purchase', `Would you like to buy ${item.name} for $${item.price}?`)}
            >
              <Text style={styles.viewProductButtonText}>Buy Now</Text>
            </TouchableOpacity>
          )}
        ...
        <View style={styles.screenContainer}>
          <View style={styles.header}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => Alert.alert('Add Product', 'Feature to add new product to your shop coming soon!')}
            >
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            <View style={styles.noShopContainer}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => Alert.alert('Create Shop', 'Shop creation feature coming soon! You will be able to:\n\n• Upload shop logo\n• Set shop description\n• Add your first products\n• Start selling to customers')}
              >
      ...
      <SafeAreaView style={styles.safeContainer}>
        <View style={styles.screenContainer}>
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            {/* Privacy & Security */}
            <View style={styles.settingsSection}>
              <Text style={styles.sectionTitle}>{t('privacy')} & {t('security')}</Text>
              
              <TouchableOpacity 
                style={styles.settingButton}
                onPress={() => Alert.alert('Privacy Policy', 'Privacy policy content will be displayed here.')}
              >
                <Ionicons name="shield-outline" size={24} color="#E91E63" />
                <Text style={styles.settingButtonText}>{t('privacyPolicy')}</Text>
            ...
            {/* Support & About */}
            <View style={styles.settingsSection}>
              <Text style={styles.sectionTitle}>{t('support')} & {t('about')}</Text>
              
              <TouchableOpacity 
                style={styles.settingButton}
                onPress={() => Alert.alert('Support', 'Contact our support team:\n\nEmail: support@leemaz.com\nPhone: +963-XXX-XXXX\n\nWe are here to help you!')}
              >
                <Ionicons name="help-circle-outline" size={24} color="#E91E63" />
                <Text style={styles.settingButtonText}>{t('support')}</Text>
                <Ionicons name="chevron-forward" size={20} color="#ccc" />
              </TouchableOpacity>

              <TouchableOpacity 
                style={styles.settingButton}
                onPress={() => Alert.alert('About Leemaz', 'Leemaz - Syrian Women\'s Marketplace\n\nVersion: 1.0.0\nBuild: 2024.01\n\nEmpowering Syrian women entrepreneurs through digital commerce.')}
              >
                <Ionicons name="information-circle-outline" size={24} color="#E91E63" />
                <Text style={styles.settingButtonText}>{t('about')} Leemaz</Text>
                <Ionicons name="chevron-forward" size={20} color="#ccc" />
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.settingsSection}>
              ...
              >
                ...
                <Text style={[styles.settingButtonText, styles.dangerText]}>{t('deleteAccount')}</Text>
      ...
      >
        <View style={styles.statsGrid}>
          <TouchableOpacity 
            ...
            onPress={() => Alert.alert('Total Users', 'View detailed user statistics and analytics.')}
          >
          ...
          <TouchableOpacity 
            style={styles.statCard}
            onPress={() => Alert.alert('Active Shops', 'View all active shops and their performance.')}
          >
          ...
          <TouchableOpacity 
            style={styles.statCard}
            onPress={() => Alert.alert('Products Listed', 'View all products across all shops.')}
          >
          ...
          <TouchableOpacity 
            style={styles.statCard}
            onPress={() => Alert.alert('Reviews', 'View all customer reviews and ratings.')}
          >
          ...
          <View style={styles.content}>
            ...
            {currentView === 'settings' && (
              <View style={styles.comingSoonContainer}>
                ...
                <Text style={styles.comingSoonText}>Configure system-wide settings, credit pricing, and platform configurations.</Text>
              </View>
            )}
          </View>
        </View>
