...
export default function App() {
  ...
  const handleLogin = (email, password) => {
    // Mock login logic
    const account = Object.values(MOCK_USER_ACCOUNTS).find(acc => acc.email === email);
    if (account) {
      setUser(account);
      ...
      <SafeAreaView style={styles.authContainer}>
        <ScrollView contentContainerStyle={styles.authContent}>
          ...
          <View style={styles.demoInfo}>
            ...
            <Text style={styles.demoText}>Seller: seller@leemaz.com</Text>
  ...
  const AdminPanelScreen = () => {
    ...
    const renderUserManagement = () => (
      <ScrollView contentContainerStyle={styles.managementContainer}>
